...
export default function LandingPage() {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 relative">
      {/* TOP RIGHT AUTH */}
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-5xl text-center">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <button
              onClick={() => navigate("/signup")}
              className="px-6 py-3 rounded-lg text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 transition"
            >
              Get Started
            </button>
            <button
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg opacity-90">Build a brain that grows smarter with you.</p>
          <button
            onClick={() => navigate("/signup")}
            className="mt-8 px-8 py-4 bg-white text-slate-800 rounded-lg font-semibold hover:bg-slate-100 transition"
          >
